...
Call log:
  ...
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      ...
      - done scrolling
      - <iframe class="" width="360px" scrolling="no" height="434px" frameborder="0" src="about:blank" id="dd8hama7e3is1787976273952" referrerpolicy="no-referrer-when-downgrade"></iframe> from <div id="r2s93mq0vjlk1787976273891">…</div> subtree intercepts pointer events
    ...
    - generic [ref=e35]:
      ...
      - generic [ref=e38]:
        ...
        - generic [ref=e60]:
          - generic [ref=e61]:
            - generic [ref=e63]:
              - textbox "Họ và tên" [ref=e64]: auto test 1787976208482
              - generic: Họ và tên
            - generic [ref=e66]:
    ...
    - generic [ref=e83]:
      ...
      - generic [ref=e229]:
        ...
        - generic [ref=e231]:
          - generic [ref=e232]:
            - text: "Đang online:"
            - generic [ref=e233]: "2019"
          - generic [ref=e234]: "|"
          - generic [ref=e235]:
            - text: "Hôm nay:"
            - generic [ref=e236]: "198"
          - generic [ref=e237]: "|"
          - generic [ref=e238]:
            - text: "Tổng truy cập:"
            - generic [ref=e239]: "3921"
  - generic:
    - iframe [ref=e240]:
      - generic [ref=f3e3]:
        - generic [ref=f3e4]: "1"
    ...
    - iframe [ref=e241]:
      - button "👋 Quảng Cáo Minh Lợi xin chào quý khách. Quý khách cần hỗ trợ gì? Tôi cần tư vấn chiến dịch quảng cáo truyền thông Tư vấn làm pano quảng cáo tấm lớn Dịch vụ treo cờ phướn & băng rôn toàn quốc ? Biển hiệu quảng cáo chuỗi hệ thống & cửa hàng" [ref=f5e7] [cursor=pointer]:
        - paragraph [ref=f5e13]:
          - generic [ref=f5e15]:
            - img "👋" [ref=f5e16]
            - text: Quảng Cáo Minh Lợi xin chào quý khách. Quý khách cần hỗ trợ gì?
        - generic [ref=f5e18]:
          - button "Tôi cần tư vấn chiến dịch quảng cáo truyền thông" [ref=f5e20]
          - button "Tư vấn làm pano quảng cáo tấm lớn" [ref=f5e22]
          - button "Dịch vụ treo cờ phướn & băng rôn toàn quốc ?" [ref=f5e24]
          - button "Biển hiệu quảng cáo chuỗi hệ thống & cửa hàng" [ref=f5e26]
```
