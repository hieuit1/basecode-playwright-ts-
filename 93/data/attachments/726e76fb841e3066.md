  ...
  - generic [ref=e14]:
    ...
    - generic [ref=e83]:
      - combobox [ref=e86]:
        ...
        - option "EN"
      - generic [ref=e87]:
        - heading "Chào mừng trở lại, Admin" [level=1] [ref=e88]
        - paragraph [ref=e89]: Đăng nhập để truy cập bảng điều khiển quản trị website.
      - generic [ref=e90]:
        - generic [ref=e91]:
          - generic [ref=e92]: Tài khoản *
          - textbox "Tài khoản *" [ref=e93]:
            - /placeholder: Nhập tên đăng nhập
            - text: admin
        - generic [ref=e94]:
          - generic [ref=e95]: Mật khẩu *
          - generic [ref=e96]:
            - textbox "Mật khẩu *" [active] [ref=e97]:
              - /placeholder: ••••••••••••••••••••••
              - text: 7G9R8PKNXF
        ...
        - generic [ref=e100]:
          - generic [ref=e101]:
            - checkbox "Ghi nhớ đăng nhập" [checked] [ref=e102]
            - text: Ghi nhớ đăng nhập
          - link "Quên mật khẩu ?" [ref=e104] [cursor=pointer]:
            - /url: forgot-password
        - button "Đăng nhập" [ref=e105] [cursor=pointer]: Đăng nhập
      - alert
      - generic [ref=e113]:
        - generic [ref=e114]: "Chia sẻ với:"
        - generic [ref=e115]:
      ...
      - generic [ref=e124]:
        ...
        - link "Chính sách bảo mật" [ref=e125] [cursor=pointer]:
